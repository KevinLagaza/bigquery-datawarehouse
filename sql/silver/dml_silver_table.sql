CREATE OR REPLACE PROCEDURE `<project_id>.silver.load_silver` (IN execution_date DATE)
...
BEGIN
    ...
    CREATE TABLE IF NOT EXISTS `<project_id>.silver.procedure_logs` (
        log_id STRING,
    ...
    -- Log procedure start
    INSERT INTO `<project_id>.silver.procedure_logs`
    VALUES (
            GENERATE_UUID(),
            batch_start_time,
    ...
    BEGIN
        ...
        TRUNCATE TABLE `<project_id>.silver.crm_cust_info`;

        INSERT INTO `<project_id>.silver.crm_cust_info`
        (
            cst_id,
            cst_key,
            cst_firstname,
        ...
        FROM (
            ...
            FROM `<project_id>.bronze.crm_cust_info`
        ...
        TRUNCATE TABLE `<project_id>.silver.crm_prd_info`;

        INSERT INTO `<project_id>.silver.crm_prd_info`
        (
            prd_id,
            cat_id,
            prd_key,
        ...
        FROM `<project_id>.bronze.crm_prd_info`;
        ...
        TRUNCATE TABLE `<project_id>.silver.crm_sales_details`;

        INSERT INTO `<project_id>.silver.crm_sales_details`(
            sls_ord_num,
            sls_prd_key,
            sls_cust_id,
            sls_order_dt,
        ...
        TRUNCATE TABLE `<project_id>.silver.erp_cust_az12`;

        INSERT INTO `<project_id>.silver.erp_cust_az12`
        (
            cid,
            bdate,
            gen
        ...
        FROM `<project_id>.bronze.erp_cust_az12`;
        ...
        TRUNCATE TABLE `<project_id>.silver.erp_loc_a101`;

        INSERT INTO `<project_id>.silver.erp_loc_a101`
        (
            cid,
            cntry	
        )
        ...
        FROM `<project_id>.bronze.erp_loc_a101`;
        ...
        TRUNCATE TABLE `<project_id>.silver.erp_px_cat_g1v2`;

        INSERT INTO `<project_id>.silver.erp_px_cat_g1v2`
        (
            id,
            cat,
            subcat,
        ...
        SELECT
            ...
            subcat,
            maintenance
        FROM `<project_id>.bronze.erp_px_cat_g1v2`;
